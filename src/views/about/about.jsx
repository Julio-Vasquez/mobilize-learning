          ...
          <MDBCarousel id="carousel-example-1" 
            ...
            <MDBCarouselInner role="listbox">          
              <MDBCarouselItem itemId="1" className="active">
                <div className="testimonial"> 
                  <div className="avatar mx-auto mb-3">
                    <img src="https://scontent.feyp1-1.fna.fbcdn.net/v/t1.0-9/7706_10153282643007133_8565210206721975586_n.jpg?_nc_cat=109&_nc_oc=AQl_RvE2vzC4MB2Dl7e2jDh6roaEg1u9lICMqGPjs5Ml20JF9vDGDdniJRA8vt5DNY8&_nc_ht=scontent.feyp1-1.fna&oh=a7fb21877d6a8098b2bc08944f1c54e6&oe=5E6125CA" className="rounded-circle img-fluid"
                  ...
                  <h6 className="font-weight-bold my-3">Ing Sistemas / Pedagogo</h6>          
              ...
              <MDBCarouselItem itemId="2" className="active">
                <div className="testimonial"> 
                  <div className="avatar mx-auto mb-4">
                    <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(30).jpg" className="rounded-circle img-fluid"
                    alt="First sample avatar" />
                  </div>              
                  <p className="texto-informativo">
                    <MDBIcon icon="quote-left" size="lg" />
              ...
              <MDBCarouselItem itemId="3" className="active">
                <div className="testimonial"> 
                  <div className="avatar mx-auto mb-4">
                    <img src="https://i.ibb.co/Zf19c4h/Most-Beautiful-Girls-Wallpapers.jpg" className="rounded-circle img-fluid"
                    alt="First sample avatar" />
                  </div>              
                  <p className="texto-informativo">
                    <MDBIcon icon="quote-left" size="lg" />
              ...
              <MDBCarouselItem itemId="4" className="active">
                <div className="testimonial"> 
                  <div className="avatar mx-auto mb-4">
                    <img src="https://image.ibb.co/gbeBCx/julio.jpg" className="rounded-circle img-fluid"
                    alt="First sample avatar" />
                  </div>              
                  <p className="texto-informativo">
                    <MDBIcon icon="quote-left" size="lg" />
